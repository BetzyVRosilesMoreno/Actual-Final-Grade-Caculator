//
//  ContentView.swift
//  Actual Final Grade Caculator
//
//  Created by Betzy Moreno on 10/4/23.
//
...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            CustomText(text: "Final Grade Caculator")
            CustomTextField(placeholder: "currentGradeTextField", variable: $currentGradeTextField)
